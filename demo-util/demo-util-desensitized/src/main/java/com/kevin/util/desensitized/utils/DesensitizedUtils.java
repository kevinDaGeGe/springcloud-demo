...
import com.kevin.util.desensitized.annotation.Desensitized;
...
public class DesensitizedUtils {
    ...
    public static String getJson(Object javaBean) {
        ...
        return PrintStyleUtil.formatJson(json);
    }
    ...
    public static void main(String[] args) {
    	System.out.println(DesensitizedUtils.bankCard("12345678901"));
    }
