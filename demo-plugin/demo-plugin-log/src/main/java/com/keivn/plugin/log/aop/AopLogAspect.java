package com.keivn.plugin.log.aop;

import com.alibaba.fastjson.JSONObject;
import com.keivn.plugin.log.kafka.KafkaSender;
...
/***
* @Description: 通过aop技术拦截业务层方法,在方法前后加上日志,并发送至MQ进行收集
* @throws  
* @author: yu.han
* @date: 2020/8/3 17:19
*/
...
public class AopLogAspect {
	...
	@Pointcut("execution(* com.kevin.*.api.service.impl.*.*(..))")
	...
	public void methodBefore(JoinPoint joinPoint) {
		...
		asyncSend(joinPoint, request);

	}

	@Async
	void asyncSend(JoinPoint joinPoint, HttpServletRequest request) {
